...
public:
    McULTRABuilder(const Data& data) : data(data) { stopEventGraph.addVertices(data.numberOfStopEvents()); }
...
#pragma omp critical
    ...
    inline const DynamicTransferGraph& getStopEventGraph() const noexcept { return stopEventGraph; }

    inline DynamicTransferGraph& getStopEventGraph() noexcept { return stopEventGraph; }
