...
public:
    StopEventGraphBuilder(const Data& data) : data(data), labels(data.numberOfStops()), timestamp(0) {
...
public:
    ...
    inline const SimpleDynamicGraphWithARCFlag& getStopEventGraph() const noexcept { return keptTransfers; }

    inline SimpleDynamicGraphWithARCFlag& getStopEventGraph() noexcept { return keptTransfers; }
...
inline void ComputeStopEventGraphRouteBased(Data& data, const int numberOfThreads,
