...
public:
    ...
    template <AttributeNameType ATTRIBUTE_NAME>
    inline const AttributeReferenceType<ATTRIBUTE_NAME>
    operator[](const AttributeNameWrapper<ATTRIBUTE_NAME> attributeName) const noexcept {
        return attributes[attributeName][index];
    }
    template <AttributeNameType ATTRIBUTE_NAME>
    inline AttributeReferenceType<ATTRIBUTE_NAME>
    operator[](const AttributeNameWrapper<ATTRIBUTE_NAME> attributeName) noexcept {
        return attributes[attributeName][index];
    }
