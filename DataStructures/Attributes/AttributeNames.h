...
inline constexpr ImplementationDetail::GetOldAttributeName<NAME, Meta::List<>, NAME_CHANGES...>
getOldAttributeName(const AttributeNameWrapper<NAME>, const NAME_CHANGES...) noexcept {
