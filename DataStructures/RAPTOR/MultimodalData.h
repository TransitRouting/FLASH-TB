...
public:
    ...
    inline void useImplicitDepartureBufferTimes() noexcept { raptorData.useImplicitDepartureBufferTimes(); }

    inline void dontUseImplicitDepartureBufferTimes() noexcept { raptorData.dontUseImplicitDepartureBufferTimes(); }

    inline void useImplicitArrivalBufferTimes() noexcept { raptorData.useImplicitArrivalBufferTimes(); }

    inline void dontUseImplicitArrivalBufferTimes() noexcept { raptorData.dontUseImplicitArrivalBufferTimes(); }
