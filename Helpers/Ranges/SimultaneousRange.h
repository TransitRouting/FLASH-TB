...
public:
    ...
    SimultaneousRange() : rangeA(nullptr), rangeB(nullptr) {}

    SimultaneousRange(const RangeA& rangeA, const RangeB& rangeB) : rangeA(&rangeA), rangeB(&rangeB) {
    ...
    inline bool empty() const noexcept { return (rangeA) ? rangeA->empty() : true; }
